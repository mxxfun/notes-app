                    ...
                    export default function NoteContextMenu({ onClose, initialNote }: NoteContextMenuProps) {
                      ...
                      const [date, setDate] = useState<Date | undefined>(initialNote?.deadline ? new Date(initialNote.deadline) : new Date())
